 ...
 *
 * This is the contract meant to be governed my DSCEngine. This contract is just the ERC20 implementation of of our stablecoin system.
 * 
 */
...
contract DecentralizedStableCoin is ERC20Burnable, Ownable {
  ...
  function burn(uint256 _amount) public override onlyOwner {
    ...
    // super keyword below specifies that it should sue the burn function from the parent class ie ERC20Burnable
    super.burn(_amount);
